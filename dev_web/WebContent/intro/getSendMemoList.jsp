...
<table border="1" borderColor="orange" width="100%" height="100%">
	...
	<td align="center">
	<!-- 보낸쪽지 목록 시작 -->
<table id="b_smemoList" toolbar="#tbar_smemoList" title="받은쪽지함" class="easyui-datagrid" style="width:800px;height:400px"rownumbers="true">
<!--테이블 헤더 구성하기  -->
<thead>
<tr>
<th field="ab_no" align="center" width="80">번호</th>
<th  field="mem_name" align="center" width="150">받는이</th>
<th  field="from_id" align="center" width="150">받는이 아이디</th>
